function maketransparencymasks_nogridlinesnostates_5km(res)
...
if nargin==0
   maketransparencymasks_nogridlinesnostates_5km('r150');
   maketransparencymasks_nogridlinesnostates_5km('r300');
   maketransparencymasks_nogridlinesnostates_5km('r400');
   maketransparencymasks_nogridlinesnostates_5km('r500');
   maketransparencymasks_nogridlinesnostates_5km('r600');
   maketransparencymasks_nogridlinesnostates_5km('r1200');
   return
end
ii=datablank(0,'5km');
...
%         disp('warning ... using a new resolution ... making masks')
        ...
        VerNo=ver(1)
        vs=['ver' VerNo '_'];  % ' vs '
        FileName=[iddstring '/misc/mask/OutputMask_colorbar_' res 'nogridnostates5km.png'];
        FileNameNCB=[iddstring '/misc/mask/OutputMask_nocolorbar_' res 'nogridnostates5km.png'];
        FileNameOceans=[iddstring '/misc/mask/OutputMask_oceans_' res 'nogridnostates5km.png'];
        FileNameAgriMask=[iddstring '/misc/mask/OutputMask_agrimask_' res 'nogridnostates5km.png'];
        FileNamePT=[iddstring '/misc/mask/OutputMask_PT_' res 'nogridnostates5km.png'];  % panoply triangles
        FileNamePTL=[iddstring '/misc/mask/OutputMask_PTL_' res 'nogridnostates5km.png'];  % panoply triangles
        FileNamePTR=[iddstring '/misc/mask/OutputMask_PTR_' res 'nogridnostates5km.png'];  % panoply triangles
...
ii=AgriMaskLogical(ii); % passing in ii so we get the correct size.
jj=LandMaskLogical(ii);
kk=(jj & ~ii);
k=double(kk);
k(k==1)=NaN;
