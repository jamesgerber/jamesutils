function maketransparencymasks_projection(res,projection)
...
if nargin==1
    projection=res;
   maketransparencymasks_projection('r150',projection);
   maketransparencymasks_projection('r300',projection);
   maketransparencymasks_projection('r400',projection);
   maketransparencymasks_projection('r500',projection);
   maketransparencymasks_projection('r600',projection);
...
%         disp('warning ... using a new resolution ... making masks')
        ...
        VerNo=ver(1)
        vs=['ver' VerNo '_'];  % ' vs '
        FileName=[iddstring '/misc/mask/OutputMask_colorbar_' res '_proj_' projection '.png'];
        FileNameNCB=[iddstring '/misc/mask/OutputMask_nocolorbar_' res '_proj_' projection '.png'];
        FileNameOceans=[iddstring '/misc/mask/OutputMask_oceans_' res '_proj_' projection '.png'];
        FileNameAgriMask=[iddstring '/misc/mask/OutputMask_agrimask_' res '_proj_' projection '.png'];
        FileNamePT=[iddstring '/misc/mask/OutputMask_PT_' res '_proj_' projection '.png'];  % panoply triangles
        FileNamePTL=[iddstring '/misc/mask/OutputMask_PTL_' res '_proj_' projection '.png'];  % panoply triangles
        FileNamePTR=[iddstring '/misc/mask/OutputMask_PTR_' res '_proj_' projection '.png'];  % panoply triangles
