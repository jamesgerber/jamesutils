...
FileName=[iddstring '/misc/mask/OutputMask_colorbar_' res '_gridoff.png'];
FileNameNCB=[iddstring '/misc/mask/OutputMask_nocolorbar_' res '_gridoff.png'];
FileNameOceans=[iddstring '/misc/mask/OutputMask_oceans_' res '_gridoff.png'];
FileNameAgriMask=[iddstring '/misc/mask/OutputMask_agrimask_' res '_gridoff.png'];
FileNamePT=[iddstring '/misc/mask/OutputMask_PT_' res '_gridoff.png'];
