function maketransparencymasks_generic(res,baseNSS,name)
...
% empty, make at all available resolutions.
%
...
%   maketransparencymasks_generic([],NSS,'gridoff')
%
%  List of "names" and NSS sets
%  'gridoff'   ->
%  NSS.longlatlines='off'
%
%  'nogridnostates'
...
if isempty(res)
   maketransparencymasks_generic('r150',baseNSS,name);
   maketransparencymasks_generic('r300',baseNSS,name);
   maketransparencymasks_generic('r400',baseNSS,name);
   maketransparencymasks_generic('r500',baseNSS,name);
   maketransparencymasks_generic('r600',baseNSS,name);
...
%         disp('warning ... using a new resolution ... making masks')
        ...
        nsg(landmasklogical,NSS,'filename','testfile.png');
        ...
        VerNo=ver(1)
        vs=['ver' VerNo '_'];  % ' vs '
        FileName=[iddstring '/misc/mask/OutputMask_colorbar_' res '_' name '.png'];
        FileNameNCB=[iddstring '/misc/mask/OutputMask_nocolorbar_' res '_' name '.png'];
        FileNameOceans=[iddstring '/misc/mask/OutputMask_oceans_' res '_' name '.png'];
        FileNameAgriMask=[iddstring '/misc/mask/OutputMask_agrimask_' res '_' name '.png'];
        FileNamePT=[iddstring '/misc/mask/OutputMask_PT_' res '_' name '.png'];  % panoply triangles
        FileNamePTL=[iddstring '/misc/mask/OutputMask_PTL_' res '_' name '.png'];  % panoply triangles
        FileNamePTR=[iddstring '/misc/mask/OutputMask_PTR_' res '_' name '.png'];  % panoply triangles
...
%panoply triangles 
NSG(ii,NSS,'cmap',NSS.cmap*0,'panoplytriangles',[1 1])
fud=get(gcf,'userdata')
set(fud.ColorbarHandle,'XTick',[]);
%set(fud.ColorbarHandle,'Visible','off')
