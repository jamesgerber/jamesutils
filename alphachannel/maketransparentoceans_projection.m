function maketransparentoceans(projection,OldFileName,NewFileName,TextColor,AgFlag);
...
if nargin==2 | isempty(NewFileName)
    NewFileName=strrep(OldFileName,'.png','_alpha_to');
    NewFileName=fixextension(NewFileName,'.png');
 %   NewFileName=[makesafestring(NewFileName) '.png']
else
...
FileNamePT=[iddstring '/misc/mask/OutputMask_PT_' res '_proj_' projection '.png'];
