function [ii,name]=GADMCodeToIndicesHash(GADMCode)
% GADMCodeToIndicesHash
%
%   [ii,name]=GADMCodeToIndicesHash(fasthash(GADMCode))
...
%idx=find(strcmp(g0.gadm0codes,GADMCode));
idx=find(g0.gadm0codesfasthash==GADMCode);
if numel(idx)==1
...
idx=find(g1.gadm1codesfasthash==GADMCode);
...
%idx=find(strcmp(g2.gadm2codes,GADMCode));
idx=find(g2.gadm2codesfasthash==GADMCode);
...
%idx=find(strcmp(g3.gadm3codes,GADMCode));
idx=find(g3.gadm3codesfasthash==GADMCode);
