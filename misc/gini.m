...
%
% Comments updated by KAB 2/20/12
%   to evaluate disproporionate resource use in crop production, use:
%   - pop = resource AND val = crop per resource
%   OR
%   - pop = crop production AND val = resource per crop
%
%
% Usage:
%   g = gini(pop,val)
